...
public class HomeFragmentDirections private constructor() {
  ...
  private data class ActionHomeFragmentToSettingFragment(
    public val ProfileDataString: String
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_homeFragment_to_settingFragment
  ...
  public companion object {
    ...
    public fun actionHomeFragmentToSettingFragment(ProfileDataString: String): NavDirections =
        ActionHomeFragmentToSettingFragment(ProfileDataString)
  }
}
