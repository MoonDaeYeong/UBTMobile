...
public class DialogTextInputBindingImpl extends DialogTextInputBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.et_text_code, 4);
        sViewsWithIds.put(R.id.btn_close, 5);
        sViewsWithIds.put(R.id.btn_confirm, 6);
    }
    // views
    @NonNull
    ...
    public DialogTextInputBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private DialogTextInputBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
