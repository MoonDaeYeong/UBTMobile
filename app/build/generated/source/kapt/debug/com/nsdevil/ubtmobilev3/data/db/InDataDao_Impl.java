  ...
  public InDataDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfInData = new EntityInsertionAdapter<InData>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `InData` (`dataOrder`,`dataText`,`id`,`viewOrder`,`examCode`,`media`) VALUES (?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, InData value) {
        ...
        stmt.bindLong(4, value.getViewOrder());
        if (value.getExamCode() == null) {
          stmt.bindNull(5);
        } else {
          stmt.bindString(5, value.getExamCode());
        }
        final String _tmp;
      ...
      public List<InData> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new InData(_tmpDataOrder,_tmpDataText,_tmpId,_tmpViewOrder,_tmpExamCode,_tmpMedia);
            _result.add(_item);
          }
          return _result;
        } finally {
