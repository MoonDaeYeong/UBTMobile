...
public class ListItemExamPreviewABindingImpl extends ListItemExamPreviewABinding  {
    ...
    public ListItemExamPreviewABindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ListItemExamPreviewABindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.nsdevil.ubtmobilev3.adapter.BindingAdapterKt.bindHtmlText(this.tvAnswer, answerAnswer);
        }
    }
