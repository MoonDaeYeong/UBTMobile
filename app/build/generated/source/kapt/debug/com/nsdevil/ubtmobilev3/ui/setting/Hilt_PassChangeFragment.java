...
public abstract class Hilt_PassChangeFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PassChangeFragment_GeneratedInjector) this.generatedComponent()).injectPassChangeFragment(UnsafeCasts.<PassChangeFragment>unsafeCast(this));
    }
  }
