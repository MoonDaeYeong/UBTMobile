  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `InAnswer` (`answerFlag` TEXT, `answerTrueData` TEXT, `answer` TEXT NOT NULL, `optionNumber` TEXT NOT NULL, `questionType` TEXT NOT NULL, `id` INTEGER NOT NULL, `order` INTEGER NOT NULL, `checkCount` INTEGER NOT NULL, `questionId` INTEGER NOT NULL, `examCode` TEXT NOT NULL, `viewOrder` INTEGER NOT NULL, `userChk` INTEGER NOT NULL, `textAnswer` TEXT, `fileName` TEXT, `mediaType` TEXT, `examQACode` TEXT NOT NULL, PRIMARY KEY(`id`, `examCode`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS `InData` (`dataOrder` INTEGER, `dataText` TEXT, `id` INTEGER NOT NULL, `viewOrder` INTEGER NOT NULL, `examCode` TEXT NOT NULL, `media` TEXT, PRIMARY KEY(`id`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '29f322a4470908dfb761db381a2fa07b')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsInAnswer = new HashMap<String, TableInfo.Column>(16);
        ...
        final HashMap<String, TableInfo.Column> _columnsInData = new HashMap<String, TableInfo.Column>(6);
    ...
    }, "29f322a4470908dfb761db381a2fa07b", "8239eadc585541bb02f088a14b10692e");
