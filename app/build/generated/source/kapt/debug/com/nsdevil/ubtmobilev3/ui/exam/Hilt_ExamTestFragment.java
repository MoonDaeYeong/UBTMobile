...
public abstract class Hilt_ExamTestFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExamTestFragment_GeneratedInjector) this.generatedComponent()).injectExamTestFragment(UnsafeCasts.<ExamTestFragment>unsafeCast(this));
    }
  }
