...
public abstract class Hilt_TestQuestionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TestQuestionFragment_GeneratedInjector) this.generatedComponent()).injectTestQuestionFragment(UnsafeCasts.<TestQuestionFragment>unsafeCast(this));
    }
  }
