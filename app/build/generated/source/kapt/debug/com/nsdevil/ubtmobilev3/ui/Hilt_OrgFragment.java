...
public abstract class Hilt_OrgFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrgFragment_GeneratedInjector) this.generatedComponent()).injectOrgFragment(UnsafeCasts.<OrgFragment>unsafeCast(this));
    }
  }
