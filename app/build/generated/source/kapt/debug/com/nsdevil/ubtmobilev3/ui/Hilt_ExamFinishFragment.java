...
public abstract class Hilt_ExamFinishFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExamFinishFragment_GeneratedInjector) this.generatedComponent()).injectExamFinishFragment(UnsafeCasts.<ExamFinishFragment>unsafeCast(this));
    }
  }
