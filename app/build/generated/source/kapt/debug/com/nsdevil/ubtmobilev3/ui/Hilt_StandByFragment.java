...
public abstract class Hilt_StandByFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StandByFragment_GeneratedInjector) this.generatedComponent()).injectStandByFragment(UnsafeCasts.<StandByFragment>unsafeCast(this));
    }
  }
