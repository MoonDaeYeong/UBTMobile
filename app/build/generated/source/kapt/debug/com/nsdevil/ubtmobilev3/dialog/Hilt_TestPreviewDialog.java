...
public abstract class Hilt_TestPreviewDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TestPreviewDialog() {
    super();
  }

  Hilt_TestPreviewDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TestPreviewDialog_GeneratedInjector) this.generatedComponent()).injectTestPreviewDialog(UnsafeCasts.<TestPreviewDialog>unsafeCast(this));
    }
  }
