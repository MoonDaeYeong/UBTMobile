...
public abstract class Hilt_SurveyFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SurveyFragment_GeneratedInjector) this.generatedComponent()).injectSurveyFragment(UnsafeCasts.<SurveyFragment>unsafeCast(this));
    }
  }
