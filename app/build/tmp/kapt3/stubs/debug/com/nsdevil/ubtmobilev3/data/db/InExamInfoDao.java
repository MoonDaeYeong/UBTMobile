...
public abstract interface InExamInfoDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "UPDATE InExamInfo SET submissionYN = 0 AND remainTime = totalTime WHERE examCode = :examCode")
    public abstract java.lang.Object updateRetakeInfo(@org.jetbrains.annotations.NotNull()
    java.lang.String examCode, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> p1);
    
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "UPDATE InExamInfo SET remainTime = remainTime + :addTime WHERE examCode = :examCode")
    public abstract java.lang.Object updateAddTime(@org.jetbrains.annotations.NotNull()
    java.lang.String examCode, int addTime, @org.jetbrains.annotations.NotNull()
